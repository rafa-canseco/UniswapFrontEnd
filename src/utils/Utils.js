...
const weiToTokenAmount = (amount, decimals) => ethers.formatUnits(amount, decimals)
...
export default {
    ...
    tokensToWei: (inputAmount, inputDecimals) => ethers.parseUnits(inputAmount, inputDecimals),
